    ...
    if (curl) {
        ...
        json payload = {
            ...
            {"messages", json::array({
                ...
                nothing else."}},
                {{"role", "user"}, {"content", "Adapt and react to the bash session state with the appropriate commands.
                                    This include reacting to any technical and environmental challenges. Continue providing 
                                    bash commands until you feel that the original task has been completed, then you return 
                                    0xDEAD to indicate that the task is finished."}},
